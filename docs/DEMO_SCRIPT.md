# BugOps Arena Demo Script

## 60-Second Hackathon Walkthrough

1. Open the landing page and introduce the pitch:
   "BugOps Arena turns debugging practice into a live browser game with AI-assisted learning."

2. Click **Enter Arena** and start an **All** difficulty run.

3. Fix the first challenge:
   Replace `return a - b;` with `return a + b;`, then submit.

4. Point out the live game loop:
